...
%description
failsafewm is at a very early development stage...
It is just something for REAL minimalists.
...
%description -l pl
failsafewm jest na pocz±tkowym etapie rozwoju.
Co¶ dla prawdziwych minimalistów.

U¿ycie:

Alt-Tab: zmienia cyklicznie okna.
Alt-F2 : przesuwa okno znajduj±ce siê pod kursorem myszy
	do momentu naci¶niêcia przycisku myszy.
